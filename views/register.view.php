...
<div class="container">
	<div class="row m-0 p-0">
		...
		<div class="col-6 p-5 justify-content-center">
			<p class="text-center h1 fw-bold m-5">Регистрация</p>
			<form class="px-5" name="signup" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
				...
				<div class="mb-4">		
				    <div>
					   <p class="text-black h5">Повторите Пароль:</p>
					</div>			
					<div class="input-group">				
				...
				<button type="button" class="btn btn-primary" onclick="signup.submit()">Зарегистрироваться</button>
				</div>
			...
			<span class="d-flex reg2 justify-content-center">Есть аккаунт?<a class="nav-link text-primary m-0 p-0 pl-2" href="../login/login.php">Войти</a></span>			
		</div>
